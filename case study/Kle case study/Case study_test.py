...
if __name__ == '__main__':
    ...
    ReadMyCsv1(PositiveSample_Train, 'PositiveSample_kle_Train.csv')
    PositiveSample_Validation = []
    ReadMyCsv1(PositiveSample_Validation, 'PositiveSample_kle_Validation.csv')
    PositiveSample_Test = []
    ReadMyCsv1(PositiveSample_Test, 'PositivateSample_kle_Test.csv')

    NegativeSample_Train = []
    ReadMyCsv1(NegativeSample_Train, 'NegativeSample_kle_Train.csv')
    NegativeSample_Validation = []
    ReadMyCsv1(NegativeSample_Validation, 'NegativeSample_kle_Validation.csv')
    NegativeSample_Test = []
    ReadMyCsv1(NegativeSample_Test, 'NegativeSample_kle_Test.csv')
    ...
    while CounterT < 1:
        ...
        while counter < len(ModelTestOutput):
            ...
            counter = counter + 1
        LabelPredictionProbName = 'case_kle_RealAndPredictionProbA+B' + str(CounterT) + '.csv'
        StorFile(LabelPredictionProb, LabelPredictionProbName)
        LabelPredictionName = 'case_kle_RealAndPredictionA+B' + str(CounterT) + '.csv'

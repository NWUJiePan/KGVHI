...
if __name__ == '__main__':
    ...
    AllProtein = []
    ReadMyCsv1(AllProtein, '')    #
    ProteinEmbedding = []
    ReadMyCsv3(ProteinEmbedding, '')     #

    AllNodeBehavior1 = []
    ReadMyCsv1(AllNodeBehavior1, '')
    ...
    ReadMyCsv1(PositiveSample_Train, '')
    PositiveSample_Validation = []
    ReadMyCsv1(PositiveSample_Validation, '')
    PositiveSample_Test = []
    ReadMyCsv1(PositiveSample_Test, '')

    NegativeSample_Train = []
    ReadMyCsv1(NegativeSample_Train, '')
    NegativeSample_Validation = []
    ReadMyCsv1(NegativeSample_Validation, '')
    NegativeSample_Test = []
    ReadMyCsv1(NegativeSample_Test, '')
